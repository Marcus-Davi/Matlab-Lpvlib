function [R_out,S_out] = gain_schd_lpv_RST_2DOF(B,A,teta,C,Hr,Hs,Nc,maximo,minimo,Ts,LimHoo)             
...
% ------------------ Definition of the sdpvar type variables -------------- 
...
% [B,A] = carrega_planta_lpv('Modelo_LPV_exemplo.txt',teta);
